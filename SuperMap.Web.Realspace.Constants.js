...
SuperMap.Web.Realspace.Layer3DType.prototype = {
    ...
    WMTS : 12,              //WMTS图层
	  OSGB : 15,          //OSGB图层
    Custom : 17,         //自定义图层
    VolumeFile : 21,     //三维栅格文件缓存数据图层
    BingMaps : 22,     //在线BingMap
    GoogleMaps : 23,     //在线谷歌地图
    OpenStreetMaps : 24     //在线OpenStreetMaps
}
...
SuperMap.Web.UI.Action3Ds.SceneActionType.prototype = {
	...
	ZOOMFREE : 4,					    //自由缩放
	POINTSELECT : 10,                   // 点选
	MEASUREDISTANCE : 31,	            //距离量算
	MEASUREAREA : 32,			        //面积量算
	MEASUREHEIGHT : 33,		            //高程量算
	MEASURETERRAINDISTANCE : 37,		//依地形距离量算
    MEASURETERRAINAREA:38,              //依地形面积量算
    MEASUREHORIZONTALDISTANCE:39,   // 水平距离量算
